...
uint16_t EE_ReadVariable(uint16_t VirtAddress, uint16_t* Data)
{
  ...
  uint16_t AddressValue = 0x0001, ReadStatus = 1;
  uint32_t Address = 0x0800F800, PageStartAddress = 0x0800F800;
...
static uint16_t EE_VerifyPageFullWriteVariable(uint16_t VirtAddress, uint16_t Data)
{
  FLASH_Status FlashStatus = FLASH_COMPLETE;
  uint16_t ValidPage = PAGE0;
  uint32_t Address = 0x0800F800, PageEndAddress = 0x0800FFFF;
...
{
  FLASH_Status FlashStatus = FLASH_COMPLETE;
  uint32_t NewPageAddress = 0x0800FBFF, OldPageAddress = 0x0800F800;
